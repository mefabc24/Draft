...
export function createPreviewExportHtml({ fileName }: PreviewExportOptions) {
...
<body style="${escapedThemeStyle}">
  <main class="draft-export-preview preview-pane" style="${escapedThemeStyle}">
